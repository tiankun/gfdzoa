...
@Service("certificateFilesService")
@Transactional
public class CertificateFilesServiceImpl extends CommonServiceImpl implements CertificateFilesService {

	@Override
	public void deleteFile(CertificateFilesEntity file) {
		//[1].删除附件
