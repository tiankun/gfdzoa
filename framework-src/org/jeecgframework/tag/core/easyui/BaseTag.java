...
//				sb.append("<script type=\"text/javascript\" src=\"plug-in/tools/dataformat.js\"></script>");
				...
				sb.append("<script type=\"text/javascript\" src=\"plug-in/tools/common.js\"></script>");
			}
			if(oConvertUtils.isIn("validate", types)){
				sb.append("<link rel=\"stylesheet\" href=\"/plug-in/Validform/css/tablefrom.css\" type=\"text/css\"></link>");
				sb.append("<script type=\"text/javascript\" src=\"/plug-in/validationEngine/jquery.validationEngine.js\"></script>");
				sb.append("<script type=\"text/javascript\" src=\"/plug-in/validationEngine/jquery.validationEngine-zh_CN.js\"></script>");
			}
