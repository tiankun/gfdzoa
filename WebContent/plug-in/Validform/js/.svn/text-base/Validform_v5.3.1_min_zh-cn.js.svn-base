(function($, win, undef) {
	...
	Validform.util = {
		...
		ajax_check:function(tableName,fieldName,fieldVlaue,param,exclude){
			   //获取编辑页面的数据主键
					var obid = null;
					if(param!=null){
						 var obid_id = param;
...
//			label = label.match(reg) || [ "" ];
			...
			label = label.replace(/\s(?![a-zA-Z])/g, "");
			label = label.replace(":", "");
			label = label.replace("*", "");
			label = label.replace("：", "");
			if (label != "") {
		...
		showmsg : function(msg, type, o, triggered) {
			...
			if ((type == 3 || type == 4) && o.obj) {
				//当鼠标移动到提示信息消除提示信息
				o.obj.siblings(".Validform_checktip").first().bind("mouseover",function(){
				...
				if(msg == "通过信息验证！"){
					...
					//组装冒泡样式
					var tip='<div class="formError">'+
							'<div class="formErrorContent">'+msg+'</div>'+
							'<div class="formErrorArrow">'+
							'<div class="line10"></div><div class="line9"></div><div class="line8"></div>'+
							'<div class="line7"></div><div class="line6"></div><div class="line5"></div>'+
							'<div class="line4"></div><div class="line3"></div><div class="line2">'+
							'</div><div class="line1"></div></div></div>';
					o.obj.siblings(".Validform_checktip").html(tip);
				}else{
		...
		check : function(curform, brothers, subpost, bool) {
			...
			if(validType!=null){
		       ...
		       var  ajaxResultValue=Validform.util.ajax_check(params[0],params[1],$(this).val(),$("input[name='"+params[2]+"']").val(),exclude);
