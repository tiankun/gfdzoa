...
<ul class="footer-links">
	<li style="display: inline;">&copy; <t:mutiLang langKey="common.copyright"/><a href="http://www.jeecg.org" title="Framework 1.0.0">Framework 1.0.0</a></li>
	<li style="display: inline;">&nbsp;<t:mutiLang langKey="common.copyright"/><t:mutiLang langKey="common.browser"/>:<a title="Framework 1.0.0" href="http://www.jeecg.org">Framework 1.0.0</a></li>
</ul>
</div>
</footer>
