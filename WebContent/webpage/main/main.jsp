...
<!-- 顶部-->
<div region="north" border="false" title=" Framework 1.0.0" style="BACKGROUND: #E6E6FA; height: 85px; padding: 1px; overflow: hidden;">
...
<div region="south" border="false" style="height: 25px; overflow: hidden;">
    <div align="center" style="color: #CC99FF; padding-top: 2px">&copy;
        ...
        <span class="tip">
            <a href="http://www.jeecg.org" title=" Framework 1.0.0"> Framework 1.0.0</a>
            <t:mutiLang langKey="common.copyright"/>:
            <a href="#" title=" Framework 1.0.0">Framework 1.0.0</a>
        </span>
    </div>
</div>
