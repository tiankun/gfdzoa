...
<!-- 					     	<input id="lxbh" name="lxbh" type="text" style="width: 150px" class="inputxt" datatype="*" errormsg="类型编号不为空"> -->
					...
					<td class="value">
					    ...
					    <td class="value">
					    	<input id="sqr" name="sqr" type="hidden" style="width: 150px" class="inputxt" value="${user.id}" readonly="readonly">
					     	<input id="sqr" name="sqrName" type="text" style="width: 150px" class="inputxt" value="${user.realName!=null?user.realName:ycsq.sqr}" readonly="readonly">
							<span class="Validform_checktip"></span>
			...
			<div class="formtitle" title="用车申请审批">用车申请审批流程</div>
