...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="zhbCgzxzController.do?doUpdate">
		...
		<tr>
			...
			<td class="value">
					  <input id="inputTime" name="inputTime" type="text" style="width: 150px" 
					                ...
					                value='<fmt:formatDate value='${zhbCgzxzPage.inputTime}' type="date" pattern="yyyy-MM-dd"/>'>   
