...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="zhbPlancpList" checkbox="true" fitColumns="false" title="采购计划申请" actionUrl="zhbPlancpController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="录入" width="900" icon="icon-add" url="zhbPlancpController.do?goAdd" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="zhbPlancpController.do?goUpdate" funname="update"></t:dgToolBar>
