...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zhbDhController.do?doUpdate" tiptype="1">
						...
						<td class="value">
									  <input id="aogDate" name="aogDate" type="text" style="width: 150px" 
						      						class="Wdate" onClick="WdatePicker()"
						      						 ...
						      						 value='<fmt:formatDate value='${zhbDhPage.aogDate}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
