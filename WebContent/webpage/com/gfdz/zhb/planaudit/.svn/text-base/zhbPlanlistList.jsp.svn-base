...
<table border="0" cellpadding="2" cellspacing="0" id="zhbPlanlist_table">
	<tr bgcolor="#E6E6E6" align="center">
		<td align="center" style="width: 25px;" bgcolor="#EEEEEE">序号</td>
		<td align="center" style="width:25px;" bgcolor="#EEEEEE">操作</td>
				  <td  style="width:120px; " align="center" bgcolor="#EEEEEE">
					产品名称
				  </td>
				  <!-- <td  style="width:120px; " align="center" bgcolor="#EEEEEE">
					类型
