...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="zhbPlanaditController.do?doAdd">
					...
					<input id="plancpId" name="plancpId" type="hidden" value="${zhbPlanaditPage.plancpId }">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td colspan="3" class="value">
				 <textarea id="examinExplain" style="width:500px;" class="inputxt" rows="6" name="examinExplain"></textarea>
				<span class="Validform_checktip"></span>
			...
			<div style="width: auto;height: 200px;">
			  ...
			  <div style="width:800px;height:1px;"></div>
				<t:tabs id="tt" iframe="false" tabPosition="top" fit="false">
				 <t:tab href="zhbPlanaditController.do?zhbPlanlistList&id=${zhbPlanaditPage.id}" icon="icon-search" title="计划采购材料清单" id="zhbPlanlist"></t:tab>
				</t:tabs>
			</div>
			</t:formvalid>
			<!-- 添加 附表明细 模版 -->
