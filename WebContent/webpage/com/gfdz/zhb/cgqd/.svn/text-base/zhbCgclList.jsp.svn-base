	 ...
	 $.dialog({
			...
			button : [ {
				...
				callback : function() {
					...
					var tr =  $("#add_zhbCgcl_table_template tr").clone();
	 				$("#add_zhbPlanlist_table").append(tr);
	 	 			resetTrNum('add_zhbPlanlist_table');
					...
					var getbrand = iframe.getcpListSelections('brand');
					 // alert(getcpmc);
					  ...
					  $("#zhbCgclListcp"+data+"").val(getprjectid);
					 $("#zhbCgclListcpmc"+data+"").val(getcpmc);
					//$("#zhbCgclListlxbh"+data+"").val(getlxbh);
					$("#zhbCgclListbrand"+data+"").val(getbrand); 
...
<table  cellpadding="0" cellspacing="1" class="formtable" id="zhbPlanlist_table">
	...
	<c:if test="${fn:length(zhbCgclList)  > 0 }">
		<c:forEach items="${zhbCgclList}" var="poVal" varStatus="stuts">
			<tr >
				...
				<td width="30" align="center"><input style="width:20;"  type="checkbox" name="ck" /></td>
					<input name="zhbCgclList[${stuts.index }].id" type="hidden" value="${poVal.id }"/>
					<input name="zhbCgclList[${stuts.index }].createName" type="hidden" value="${poVal.createName }"/>
					<input name="zhbCgclList[${stuts.index }].createBy" type="hidden" value="${poVal.createBy }"/>
					<input name="zhbCgclList[${stuts.index }].createDate" type="hidden" value="${poVal.createDate }"/>
					<input name="zhbCgclList[${stuts.index }].updateName" type="hidden" value="${poVal.updateName }"/>
					<input name="zhbCgclList[${stuts.index }].updateBy" type="hidden" value="${poVal.updateBy }"/>
					<input name="zhbCgclList[${stuts.index }].updateDate" type="hidden" value="${poVal.updateDate }"/>
					<input name="zhbCgclList[${stuts.index }].cgqdId" type="hidden" value="${poVal.cgqdId }"/>
				   <td align="left" width="120" >
					        	<input id="zhbCgclListcpmc_${stuts.index }" name="" maxlength="36" 
				   ...
				   <%-- <td align="left">
					        	<input id="zhbCgclListlxbh_${stuts.index }" name="zhbCgclList[${stuts.index }].cp.lxbh" maxlength="36" 
				   ...
				   <td align="left" width="120">
					     	<input id="zhbCgclListbrand_${stuts.index }" name="zhbCgclList[${stuts.index }].cp.brand" maxlength="36" 
						  		type="text" class="inputxt"  style="width:120px;"
				   ...
				   <td align="left" width="120">
					  	<input name="zhbCgclList[${stuts.index }].appplyNumber" maxlength="32" 
					  		type="text" class="inputxt"  style="width:120px;"
					               
					                value="${poVal.appplyNumber }">
					  <label class="Validform_label" style="display: none;">计划数量</label>
				   </td>
				   <%-- <td align="left" width="120">
					  	<input name="zhbCgclList[${stuts.index }].planPrice" maxlength="32" 
					  		type="text" class="inputxt"  style="width:120px;"
				   ...
				   <td align="left" width="120">
					       	<input name="zhbCgclList[${stuts.index }].materailRemark" maxlength="300" 
						  		type="text" class="inputxt"  style="width:120px;"
					               
					                value="${poVal.materailRemark }">
					  <label class="Validform_label" style="display: none;" style="width:120px;">备注</label>
				   </td>
				   <%-- <td align="left">
					  	<input name="zhbCgclList[${stuts.index }].examinNumber" maxlength="32" 
					  		type="text" class="inputxt"  style="width:120px;"
				   ...
				   <td align="left">
					  	<input name="zhbCgclList[${stuts.index }].examinPrice" maxlength="32" 
					  		type="text" class="inputxt"  style="width:120px;"
