...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="attendanceList" queryMode="group" title="考勤记录" actionUrl="attendanceController.do?countdatagrid" idField="id" fit="true">
   <t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
<%--    <t:dgCol title="用户名称" field="username" ></t:dgCol>  --%>
   
   <t:dgCol title="考勤日期" field="normDate" hidden="true" formatter="yyyy-MM-dd" query="true" queryMode="group" extend="{class:{value:'easyui-datebox'}}"></t:dgCol>
   <t:dgCol title="月份" field="normonth"   ></t:dgCol>
   <t:dgCol title="姓名" field="normRealname"   query="true"></t:dgCol>
   <t:dgCol title="部门" field="normdepartname" query="true"></t:dgCol>
   <t:dgCol title="迟到天数" field="late" ></t:dgCol>
   <t:dgCol title="放假天数" field="recess"  ></t:dgCol>
   <t:dgCol title="缺勤天数" field="absenteeism"  ></t:dgCol>
   <t:dgCol title="正常上班" field="normalworking"  ></t:dgCol>
