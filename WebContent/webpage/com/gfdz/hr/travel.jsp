...
<html>
 ...
 <body style="overflow-y: hidden" scroll="no">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="travelController.do?save">
		...
		<div class="formtitle" title="出差路线">出差路线</div>
				...
				<div style="width: auto; height: auto; ">
					<table cellpadding="0" cellspacing="1" class="formtable" id="travelpath" class="formtable">
						<tr bgcolor="#E6E6E6" style="line-height:25px">
							<td align="center" bgcolor="#EEEEEE">序号</td>
							<td align="center" bgcolor="#EEEEEE">名称</td>
							<td align="center" bgcolor="#EEEEEE">具体建设内容</td>	
							<td align="center" bgcolor="#EEEEEE">投资估算</td>	
