...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="materialList" title="项目设计材料明细" actionUrl="projectInfoController.do?materialListData&pId=${param.pId }" idField="id" fit="true">
   <t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
   <t:dgCol title="设备名称" field="cp.cpmc" width="100"></t:dgCol>
   <t:dgCol title="品牌" field="brand" width="100"></t:dgCol>
   <t:dgCol title="规格型号" field="model" width="100"></t:dgCol>
   <t:dgCol title="技术参数" field="parameter" width="100"></t:dgCol>
   <t:dgCol title="单位" field="unit" width="100"></t:dgCol>
   <t:dgCol title="设计数量" field="designAmount" width="100"></t:dgCol>
