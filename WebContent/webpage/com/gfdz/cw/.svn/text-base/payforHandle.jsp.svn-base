...
.opt {
 ...
 <body style="overflow-y: hidden">
  <t:formvalid formid="formobj" dialog="true" tiptype="3" layout="table" action="payforController.do?completeTask">
...
<%--	           <td><fmt:formatNumber pattern="#0.00" value="${p.purchase.qkMoney}"/></td>--%>
   ...
   <c:if test="${param.taskKey!='cashierExpenditure' && param.taskKey!='invoiceRegister'}">
   ...
   <c:if test="${param.taskKey=='cashierExpenditure'}">
    <div class="easyui-panel" title="支付信息" style="width:auto;height:auto;margin-bottom:5px;padding: 5px;"data-options="doSize:false">
      <table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
				<input class="inputxt" style="color: red" readonly="readonly" value="<fmt:formatNumber pattern="#0.00" value="${money}"/>">
			</td>
			<td align="right" style="width: 90px">
				<label class="Validform_label">
					支付时间：
			...
			<td class="value">
				<input class="Wdate" datatype="*" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" style="width: 150px" name="payDate" value="">
				<span class="Validform_checktip"></span>
			</td>
			<td align="right" style="width: 90px">
				<label class="Validform_label">
    ...
    <c:if test="${param.taskKey=='invoiceRegister'}">
     <div class="easyui-panel" title="发票登记" style="width:auto;height:auto;margin-bottom:5px;padding: 5px;"data-options="doSize:false">
      <table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			<td align="right" style="width: 90px">
				<label class="Validform_label">
			...
			<td class="value">
				<input class="inputxt" value="" name="code" datatype="*" >
			</td>
			<td align="right" style="width: 90px">
				<label class="Validform_label">
					开票时间：
			...
			<td class="value">
				<input class="Wdate" datatype="*" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" style="width: 150px" name="makeCodeDate" value="">
				<span class="Validform_checktip"></span>
			</td>
			<td align="right" style="width: 90px">
				<label class="Validform_label">
