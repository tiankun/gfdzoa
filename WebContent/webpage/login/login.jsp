...
<!--             <img src="plug-in/login/images/foot.png" /> -->
            </div>
            <div class="formLogin">
    ...
    <div class="clear"></div>
    <div id="versionBar">
        <div class="copyright" style="font-size: 12px;">&copy; <t:mutiLang langKey="common.copyright"/> <span class="tip"><a href="#" title=<t:mutiLang langKey="common.platform"/>>官房电子</a>(推荐使用<a href="/upload/GoogleChrome_42.0.2311.90.exe">谷歌浏览器</a>可以获得更快,更安全的页面响应速度) 技术支持：:官房电子:<a href="#" title=<t:mutiLang langKey="common.platform"/>>官房电子</a></span></div>
    </div>
    <!-- Link JScript-->
