...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="supplierController.do?doUpdate" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="supplierName" name="supplierName" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${supplierPage.supplierName}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="supplierModel" name="supplierModel" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${supplierPage.supplierModel}'>
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="supplierContact" name="supplierContact" type="text" style="width: 150px" class="inputxt"  
								           value='${supplierPage.supplierContact}'>
							<span class="Validform_checktip"></span>
