...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="goodsController.do?doAdd" tiptype="3">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					     	  <t:dictSelect field="goodsband" typeGroupCode="goodsBrand" hasLabel="false" defaultVal=""></t:dictSelect>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="goodsPrice" name="goodsPrice" type="text" style="width: 150px" class="inputxt" datatype="d">
							<span class="Validform_checktip"></span>
  ...
  <script src = "webpage/buss/goods/baseGoods.js"></script>		