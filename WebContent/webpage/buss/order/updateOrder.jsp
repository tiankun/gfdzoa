...
function addCost(){
 ...
 <body>
  <form name="formobj" id="formobj" action="orderController.do?doUpdate">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
			  ...
			  <input type="text" readonly="readonly" id="orderNumber" class="inputxt" name="orderNumber" value="${orderPage.orderNumber }">
			</td>
		...
		<tr>
			<td align="right"><label class="Validform_label">销售人:</label></td>
				<td class="value">
					<input class="inputxt" id="orderSaleser" name="orderSaleser" value="${orderPage.orderSaleser }">
					<span class="Validform_checktip"></span>
			</td>
			<td align="right"><label class="Validform_label">联系方式:</label></td>
			<td class="value">
				<input class="inputxt" id="orderPhone" name="orderPhone" value="${orderPage.orderPhone }">
				<span class="Validform_checktip"></span>
			</td>
			</tr>
			<tr>
			...
			<td class="value" colspan="3">
				<input style="width:583px" class="inputxt" id="orderAddress" name="orderAddress" value="${orderPage.orderAddress }">
				<span class="Validform_checktip"></span>
			</td>
		</tr>
		<tr>
			...
			<td class="value" colspan="3">
				<input class="inputxt" id="orderNote" name="orderNote" value="${orderPage.orderNote }"  style="width:583px">
				<span class="Validform_checktip"></span>
			</td>
		</tr>
	</table>
...
function saveData(){
	$.post('orderController.do?doUpdate',$("#formobj").serialize(),function(data){
